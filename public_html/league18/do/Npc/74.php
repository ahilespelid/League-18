<?
	...
	switch($npcStep){
		...
		case 2:
			$response['question'] = '
			Поездка из <b>Хоэнн</b> в <b>Канто</b> будет стоить <b><i>400.000 монет</i></b>. Вы будете добираться туда <b>2 часа</b>.
			';
			$response['answer'] = array(
				3 => "Я хочу в Канто"
			);
		...
		default:
			...
			Поездка из <b>Хоэнн</b> в <b>Канто</b> будет стоить <b><i>400.000 монет</i></b>
			';
			$response['answer'] = array(
