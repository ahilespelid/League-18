<?
	...
	switch($npcStep){
		  case 1:
		 	 ...
		 	 <br><span class="bgPok" onclick=openDex("396")><img src="/img/pokemons/anim/normal/396.gif"> #396 Старли</span> за <b>1.000.000 мон.</b> - <a href="#" onclick="NpcDialog(119,2,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("453")><img src="/img/pokemons/anim/normal/453.gif"> #453 Кроуганк</span> за <b>1.200.000 мон.</b> - <a href="#" onclick="NpcDialog(119,3,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("179")><img src="/img/pokemons/anim/normal/179.gif"> #179 Марип</span> за <b>1.200.000 мон.</b> - <a href="#" onclick="NpcDialog(119,4,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("543")><img src="/img/pokemons/anim/normal/543.gif"> #543 Венипед</span> за <b>1.400.000 мон.</b> - <a href="#" onclick="NpcDialog(119,5,event);">Приобрести</a>
		 	 <br><span class="bgPok" onclick=openDex("102")><img src="/img/pokemons/anim/normal/102.gif"> #102 Экзекут</span> за <b>1.600.000 мон.</b> - <a href="#" onclick="NpcDialog(119,6,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("120")><img src="/img/pokemons/anim/normal/120.gif"> #120 Старью</span> за <b>1.800.000 мон.</b> - <a href="#" onclick="NpcDialog(119,7,event);">Приобрести</a>
		 	 <br><span class="bgPok" onclick=openDex("280")><img src="/img/pokemons/anim/normal/280.gif"> #280 Ральтс</span> за <b>2.000.000 мон.</b> - <a href="#" onclick="NpcDialog(119,8,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("359")><img src="/img/pokemons/anim/normal/359.gif"> #359 Абсол</span> за <b>2.200.000 мон.</b> - <a href="#" onclick="NpcDialog(119,9,event);">Приобрести</a>
		 	 <br><span class="bgPok" onclick=openDex("559")><img src="/img/pokemons/anim/normal/559.gif"> #559 Скрагги</span> за <b>2.500.000 мон.</b> - <a href="#" onclick="NpcDialog(119,10,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("214")><img src="/img/pokemons/anim/normal/214.gif"> #214 Геракросс</span> за <b>3.000.000 мон.</b> - <a href="#" onclick="NpcDialog(119,11,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("355")><img src="/img/pokemons/anim/normal/355.gif"> #355 Даскулл</span> за <b>4.000.000 мон.</b> - <a href="#" onclick="NpcDialog(119,12,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("196")><img src="/img/pokemons/anim/normal/196.gif"> #196 Эспеон</span> за <b>5.000.000 мон.</b> - <a href="#" onclick="NpcDialog(119,13,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("704")><img src="/img/pokemons/anim/normal/704.gif"> #704 Гуми</span> за <b>7.000.000 мон.</b> - <a href="#" onclick="NpcDialog(119,14,event);">Приобрести</a>
		  ...
		  break;
		    ...
		    break;
		    	case 14:
		 	 if(item_isset(1,7000000)){
		   		 $response['actionQuestPlus'] = '<img src="/img/world/items/little/54.png" class="item"> Яйцо (1 шт.)';
		 		 $response['actionQuestMinus'] = '<img src="/img/world/items/little/1.png" class="item"> Монета (7000000 шт.)';
		   		 $response['question'] = 'Спасибо за покупку!';
				 plusEgg('28,28,28,28,28,28',false,1,false,false,704,false);
		   		 minus_item(1,7000000);
			 }else{
		   		 $response['question'] = 'Недостаточно денег!';
		 	 }
		    break;
