<?
	...
	switch($npcStep){
		...
		case 2:
			if(!quest_isset(4)){
				$response['question'] = 'Эти.. Плохие покемоны! <b>#568 Траббиши</b>! Они напали на меня и отобрали мою <div class="itemIsset" onclick="issetAll(24,\'item\')" style="background-image: url(/img/world/items/little/24.png)"></div> игрушку! <i>~Начинает еще сильнее плакать~</i>';
				$response['answer'] = array(
