<?
	...
	switch($npcStep){
		...
		case 2:
			$response['question'] = '
			Поездка из <b>Канто</b> в <b>Хоэнн</b> будет стоить <b><i>400.000 монет</i></b>. Вы будете добираться туда <b>2 часа</b>.<br>
			Поездка из <b>Канто</b> в <b>Джото</b> будет стоить <b><i>250.000 монет</i></b>. Вы будете добираться туда <b>3 часа</b>.<br>
			';
			$response['answer'] = array(
				3 => "Я хочу в Хоэнн",
				4 => "Я хочу в Джото"
		...
		default:
			...
			Поездка из <b>Канто</b> в <b>Хоэнн</b> будет стоить <b><i>400.000 монет</i></b><br>
			Поездка из <b>Канто</b> в <b>Джото</b> будет стоить <b><i>250.000 монет</i></b><br>
			';
			$response['answer'] = array(
