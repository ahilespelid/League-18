...
<div class="Block">
            ...
            <div class="Cnt">
						 <a href="https://www.twitch.tv/mikkinels" target="_blank" class="sob konk">
							<div class="Text">
								<div>Стримы нашего Друга:</div>
								<span>Каждый день 17:00 МСК. <img src=https://league-18.ru/img/button/twibutt2.png></span>
							</div>
						</a>
						<a href="http://leagueonline.forum2.net/viewtopic.php?id=114" target="_blank" class="sob konk">
							<div class="Text">
								<div>[Турнир Внезапный, 3.1] Древний монстр | 9.03.19</div>
								<span>Приз: <img src=https://league-18.ru/img/pokemons/anim/normal/696.gif> #696 Тайрант shine</span>
							</div>
						</a>
						<a href="http://leagueonline.forum2.net/viewtopic.php?id=112" target="_blank" class="sob konk">
							<div class="Text">
								<div>[Турнир Общей Лиги, 3.1] Новая эра</div>
								<span>Приз: <img src=https://league-18.ru/img/pokemons/anim/shine/629.gif> #629 Вуллаби shine</span>
							</div>
						</a>
						<a href="http://leagueonline.forum2.net/viewtopic.php?id=113" target="_blank" class="sob konk">
							<div class="Text">
								<div>[Турнир Общей Лиги, 3.3] Весна пришла</div>
								<span>Приз: <img src=https://league-18.ru/img/pokemons/anim/normal/709.gif> #709 Тривенант shine</span>
							</div>
						</a>
            </div>
          </div>
