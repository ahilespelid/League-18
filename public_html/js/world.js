...
function bigmapworld(i) {
    dex = $(".mudolmap"), 0 !== dex.length && dex.html(""), i < 1 ? i = 807 : i > 807 && (i = 1), dexBtn = $("#DexBtn"), dexBtn.attr("class", ""), dex.attr("id", "pokedex"), dex.css("display", "block"), dex.html('<center>' + mainLoader + '</center>'), UserPokedex = i, $.ajax({
        ...
        success: function(d) {
            var s = parseInt(d.id) + 1,
                e = "";
            e += '<div class="Header">Карта Канто <div class="Close" onclick="closeMudol(1)"><i class="fa fa-close"></i></div></div>',
            e += '<div class="Content">',

            e += '<img class="postimg" src="http://dl3.joxi.net/drive/2022/12/05/0043/3410/2825554/54/c67a5016bc.png" alt="http://dl3.joxi.net/drive/2022/12/05/0043/3410/2825554/54/c67a5016bc.png">',
