<?
	...
	switch($npcStep){
		  case 1:
		 	 ...
		 	 <br><span class="bgPok" onclick=openDex("396")><img src="/img/pokemons/anim/normal/396.gif"> #396 Старли</span> за <b>10 Жемчуга.</b> - <a href="#" onclick="NpcDialog(220,2,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("453")><img src="/img/pokemons/anim/normal/453.gif"> #453 Кроуганк</span> за <b>12 Жемчуга.</b> - <a href="#" onclick="NpcDialog(220,3,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("179")><img src="/img/pokemons/anim/normal/179.gif"> #179 Марип</span> за <b>12 Жемчуга.</b> - <a href="#" onclick="NpcDialog(220,4,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("543")><img src="/img/pokemons/anim/normal/543.gif"> #543 Венипед</span> за <b>14 Жемчуга.</b> - <a href="#" onclick="NpcDialog(220,5,event);">Приобрести</a>
		 	 <br><span class="bgPok" onclick=openDex("102")><img src="/img/pokemons/anim/normal/102.gif"> #102 Экзекут</span> за <b>16 Жемчуга.</b> - <a href="#" onclick="NpcDialog(220,6,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("120")><img src="/img/pokemons/anim/normal/120.gif"> #120 Старью</span> за <b>18 Жемчуга.</b> - <a href="#" onclick="NpcDialog(220,7,event);">Приобрести</a>
		 	 <br><span class="bgPok" onclick=openDex("280")><img src="/img/pokemons/anim/normal/280.gif"> #280 Ральтс</span> за <b>120 Жемчуга.</b> - <a href="#" onclick="NpcDialog(220,8,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("359")><img src="/img/pokemons/anim/normal/359.gif"> #359 Абсол</span> за <b>22 Жемчуга.</b> - <a href="#" onclick="NpcDialog(220,9,event);">Приобрести</a>
		 	 <br><span class="bgPok" onclick=openDex("559")><img src="/img/pokemons/anim/normal/559.gif"> #559 Скрагги</span> за <b>25 Жемчуга.</b> - <a href="#" onclick="NpcDialog(220,10,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("214")><img src="/img/pokemons/anim/normal/214.gif"> #214 Геракросс</span> за <b>90 Жемчуга.</b> - <a href="#" onclick="NpcDialog(220,11,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("355")><img src="/img/pokemons/anim/normal/355.gif"> #355 Даскулл</span> за <b>40 Жемчуга.</b> - <a href="#" onclick="NpcDialog(220,12,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("133")><img src="/img/pokemons/anim/normal/133.gif"> #133 Иви</span> за <b>60 Жемчуга.</b> - <a href="#" onclick="NpcDialog(220,13,event);">Приобрести</a>
		   	 <br><span class="bgPok" onclick=openDex("704")><img src="/img/pokemons/anim/normal/704.gif"> #704 Гуми</span> за <b>200 Жемчуга.</b> - <a href="#" onclick="NpcDialog(220,14,event);">Приобрести</a>
