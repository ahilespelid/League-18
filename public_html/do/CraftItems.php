...
switch ($type) {
    ...
    case 6:
		...
		break;
    case 217:
			if(item_isset(235,$count) && item_isset(212,$count*10)){
				minus_item(235,$count);
				minus_item(212,$count*10);
				itemAdd(217,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/217.png" class="item"> Пирожное «Молодой дракон» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/212.png" class="item"> Пыль покемона дракона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 218:
			if(item_isset(235,$count) && item_isset(202,$count*10)){
				minus_item(235,$count);
				minus_item(202,$count*10);
				itemAdd(218,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/218.png" class="item"> Пирожное «Разряд молний» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/202.png" class="item"> Пыль электрического покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 219:
			if(item_isset(235,$count) && item_isset(215,$count*10)){
				minus_item(235,$count);
				minus_item(215,$count*10);
				itemAdd(219,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/219.png" class="item"> Пирожное «Волшебные бантики» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/215.png" class="item"> Пыль волшебного покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 220:
			if(item_isset(235,$count) && item_isset(216,$count*10)){
				minus_item(235,$count);
				minus_item(216,$count*100);
				itemAdd(220,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/220.png" class="item"> Пирожное «Острые камушки» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/216.png" class="item"> Пыль каменного покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 221:
			if(item_isset(235,$count) && item_isset(206,$count*10)){
				minus_item(235,$count);
				minus_item(206,$count*10);
				itemAdd(221,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/221.png" class="item"> Пирожное Пирожное «Льдинка» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/206.png" class="item"> Пыль ледяного покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 222:
			if(item_isset(235,$count) && item_isset(208,$count*10)){
				minus_item(235,$count);
				minus_item(208,$count*10);
				itemAdd(222,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/222.png" class="item"> Пирожное «Легкое перо» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/208.png" class="item"> Пыль летающего покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 223:
			if(item_isset(235,$count) && item_isset(199,$count*10)){
				minus_item(235,$count);
				minus_item(199,$count*10);
				itemAdd(223,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/223.png" class="item"> Пирожное «Лапка» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/199.png" class="item"> Пыль нормального покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 224:
			if(item_isset(235,$count) && item_isset(200,$count*10)){
				minus_item(235,$count);
				minus_item(200,$count*10);
				itemAdd(224,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/224.png" class="item"> Пирожное «Горячая магма» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/200.png" class="item"> Пыль огненного покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 225:
			if(item_isset(235,$count) && item_isset(211,$count*10)){
				minus_item(235,$count);
				minus_item(211,$count*10);
				itemAdd(225,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/225.png" class="item"> Пирожное «Заблудшие души» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/211.png" class="item"> Пыль призрачного покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 226:
			if(item_isset(235,$count) && item_isset(209,$count*10)){
				minus_item(235,$count);
				minus_item(209,$count*10);
				itemAdd(226,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/226.png" class="item"> Пирожное «Психические импульсы» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/209.png" class="item"> Пыль психического покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 227:
			if(item_isset(235,$count) && item_isset(214,$count*10)){
				minus_item(235,$count);
				minus_item(214,$count*10);
				itemAdd(227,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/227.png" class="item"> Пирожное «Шестеренки» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/214.png" class="item"> Пыль стального покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 228:
			if(item_isset(235,$count) && item_isset(213,$count*10)){
				minus_item(235,$count);
				minus_item(213,$count*10);
				itemAdd(228,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/228.png" class="item"> Пирожное «Ночной туман» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/213.png" class="item"> Пыль темного покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 229:
			if(item_isset(235,$count) && item_isset(203,$count*10)){
				minus_item(235,$count);
				minus_item(203,$count*10);
				itemAdd(229,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/229.png" class="item"> Пирожное «Зеленый лист» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/203.png" class="item"> Пыль травяного покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 230:
			if(item_isset(235,$count) && item_isset(201,$count*10)){
				minus_item(235,$count);
				minus_item(201,$count*10);
				itemAdd(230,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/230.png" class="item"> Пирожное «Водное течение» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/201.png" class="item"> Пыль водного покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 231:
			if(item_isset(235,$count) && item_isset(207,$count*10)){
				minus_item(235,$count);
				minus_item(207,$count);
				itemAdd(231,$count*10);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/231.png" class="item"> Пирожное «Чума» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/207.png" class="item"> Пыль ядовитого покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 232:
			if(item_isset(235,$count) && item_isset(205,$count*10)){
				minus_item(235,$count);
				minus_item(205,$count*10);
				itemAdd(232,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/232.png" class="item"> Пирожное «Подземелье» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/205.png" class="item"> Пыль земляного покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 233:
			if(item_isset(235,$count) && item_isset(210,$count*10)){
				minus_item(235,$count);
				minus_item(210,$count*10);
				itemAdd(233,$count);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/233.png" class="item"> Пирожное «Жужжание» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/210.png" class="item"> Пыль покемона жука ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
		...
		break;
    case 234:
			if(item_isset(235,$count) && item_isset(204,$count*10)){
				minus_item(235,$count);
				minus_item(204,$count);
				itemAdd(234,$count*10);
				$pir=$count*10;
        $response['plus'] = '<img src="/img/world/items/little/234.png" class="item"> Пирожное «Уличная драка» ('.$count.' шт.)';
        $response['minus'] = '<img src="/img/world/items/little/204.png" class="item"> Пыль боевого покемона ('.$pir.' шт.)<br><img src="/img/world/items/little/235.png" class="item"> Мука ('.$count.' шт.)';
				$response['html'] .= 'Вы удачно скрафтили предмет.';
				$response['error'] = 'success';
			}else{
				$response['html'] = 'Условия крафта не соблюдены.';
