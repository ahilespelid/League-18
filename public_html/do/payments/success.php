...
$order = $mysqli->query('SELECT p.count, u.login FROM payments p INNER JOIN users u ON p.user = u.id WHERE p.id = '.(int)$inv_id)->fetch_assoc();
?>
<!DOCTYPE html>
<html lang="ru">
    <head>
	...
	<body>
		...
		<div class="container payment">
			<div class="row justify-content-center">
				<div class="col-5">
					<div class="card text-white bg-success mt-5 w-100">
						<div class="card-header">Успешная оплата</div>
						<div class="card-body">
							<h5 class="card-title">Вам выдано <?=$order['count'];?> Акваритов. Удачной игры!</h5>
						</div>
					</div>
				</div>
			</div>
